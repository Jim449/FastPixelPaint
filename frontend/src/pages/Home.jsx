...
export default function Home() {
    return <div className="flex flex-col self-center w-[70%]">
        ...
        <p className="pl-1 pt-1 text-xs">Try out a fancy pixel font. Return of Ganon doesn't feel like a header font. Manaspace is so elongated. Mercutio is decent, maybe not the smallcaps. Teeny tiny pixls is a mess but kind of funny</p>
        <h1 className="text-2xl mx-auto p-6 font-[Crumbled_pixels]">Fast pixel paint</h1>
