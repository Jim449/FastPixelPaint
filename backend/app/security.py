...
#                 models.Token.token == token_str, models.Token.created >= datetime.now(
#                     UTC) - max_age
#             ),
#         )
#         .scalars()
...
# def get_current_superuser(current_user: Annotated[models.User, Depends(get_current_user)]) -> models.User:
#     """
